...
export default function EmailMailbox({ email = 'info@darkchemsite.com', className = '' }) {
  return (
    <a
      href={`https://mail.google.com/mail/?view=cm&to=${email}&su=Inquiry%20from%20DarkChemSite`}
      target="_blank"
