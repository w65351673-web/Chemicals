...
export default function EmailMailbox({ email = 'info@chemicalssite.com', className = '' }) {
  return (
    <a
      href={`https://mail.google.com/mail/?view=cm&to=${email}&su=Inquiry%20from%20ChemicalsSite`}
      target="_blank"
